		...
		<FrameBackground>
			...
			>
				...
				<FrameAnimate
					...
					startOpacity={0}
					endOpacity={1}
					className="fixed top-[25%] left-[30%] pointer-events-none"
				>
					<p className="text-lg md:text-xl text-white/90 max-w-[200px] md:max-w-[280px] leading-relaxed">
				...
				<FrameAnimate
					...
					startOpacity={0}
					endOpacity={1}
					className="fixed top-[30%] right-[30%] pointer-events-none text-right"
				>
					<p className="text-lg md:text-xl text-white/90 max-w-[200px] md:max-w-[280px] leading-relaxed">
				...
				<FrameAnimate
					...
					startOpacity={0}
					endOpacity={1}
					className="fixed bottom-[30%] left-[30%] pointer-events-none"
				>
					<p className="text-lg md:text-xl text-white/90 max-w-[200px] md:max-w-[280px] leading-relaxed">
				...
				<FrameAnimate
					...
					startOpacity={0}
					endOpacity={1}
					className="fixed bottom-[25%] right-[30%] pointer-events-none text-right"
				>
					<p className="text-lg md:text-xl text-white/90 max-w-[200px] md:max-w-[280px] leading-relaxed">
